...
function write_sourceFile_countryNamesAndCodes() {
   ...
   data += "};\n";
   data += "(function () {\n";
   for (var i = 0, len = countryNamesAndCodes.length; i < len; i++) {
      var item = countryNamesAndCodes[i];
      item = item.replace("'", "\\'");
      data += "countryNamesAndCodes.push('" + item + "');\n";
   }
   data += "})();\n";
...
function write_sourceFile_countries() {
   ...
   for (var i = 0, len = countries.length; i < len; i++) {
      ...
      var item = "{ipstart:" + country.ipstart + ",idx:" + country.index + "}";
      data += "countries.push(" + item + ");//" + countryNamesAndCodes[country.index + 1] + "\n";
   }
   data += "})();\n";
